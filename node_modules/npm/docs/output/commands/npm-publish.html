...
<a href="../using-npm/developers.html"><code>developers</code></a> for full details on what’s included in the published package, as well as details on how the package is built.</p>
<p>By default npm will publish to the public registry. This can be overridden by
specifying a different default registry or using a <a href="../using-npm/scope.html"><code>scope</code></a> in the name (see <a href="../configuring-npm/package-json.html"><code>package.json</code></a>).</p>
<ul>
<li>
<p><code>&lt;folder&gt;</code>:
...
<code>npm install &lt;name&gt;@&lt;tag&gt;</code> will install this version.  By default,
...
<li>
<p><code>[--access &lt;public|restricted&gt;]</code>
...
it is removed with <a href="../commands/npm-unpublish.html"><code>npm unpublish</code></a>.</p>
...
<p>Similar to <code>--dry-run</code> see <a href="../commands/npm-pack.html"><code>npm pack</code></a>, which figures out the files to be
...
<footer id="edit">
<a href="https://github.com/npm/cli/edit/v6/docs/content/commands/npm-publish.md">
