...
<p>See <a href="../using-npm/config.html">config</a> for a more thorough discussion of the mechanisms
involved.</p>
...
<footer id="edit">
<a href="https://github.com/npm/cli/edit/v6/docs/content/commands/npm-config.md">
