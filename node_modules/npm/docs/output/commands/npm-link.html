...
<code>{prefix}/lib/node_modules/&lt;package&gt;</code> that links to the package where the <code>npm link</code> command was executed. It will also link any bins in the package to <code>{prefix}/bin/{name}</code>.
...
<p>The package name can be optionally prefixed with a scope. See <a href="../using-npm/scope.html"><code>scope</code></a>.
...
<footer id="edit">
<a href="https://github.com/npm/cli/edit/v6/docs/content/commands/npm-link.md">
