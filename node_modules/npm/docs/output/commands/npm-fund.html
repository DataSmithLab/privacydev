...
is provided then it tries to open its funding url using the <code>--browser</code>
config param; if there are multiple funding sources for the package, the
user will be instructed to pass the <code>--which</code> command to disambiguate.</p>
...
list is not going to have the same shape of the output from <code>npm ls</code>.</p>
...
<footer id="edit">
<a href="https://github.com/npm/cli/edit/v6/docs/content/commands/npm-fund.md">
