...
<p>See <a href="../configuring-npm/package-json.html"><code>package.json</code></a> for details about what goes in that file.  At the very
least, you need:</p>
<ul>
<li>
<p>name:
...
started with a pretty basic package.json file.  See <a href="../commands/npm-init.html"><code>npm init</code></a> for
more info.</p>
...
<footer id="edit">
<a href="https://github.com/npm/cli/edit/v6/docs/content/using-npm/developers.md">
