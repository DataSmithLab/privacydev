...
<a href="basics/ai-tools-privacy-overview.md" style="display: inline-block; padding: 10px 16px; background-color: #f5f5f5; color: #333; text-decoration: none; border-radius: 4px; font-weight: 500; margin: 20px 0;">Detailed AI Tools Privacy Overview →</a>
...
<h4 style="background-color: #fff3e0; padding: 10px; border-radius: 4px; display: inline-block; margin-bottom: 15px;"><span class="pg-orange">⚠️ Data Training Varies by Tier</span></h4>
...
<h4 style="background-color: #e8f5e9; padding: 10px; border-radius: 4px; display: inline-block; margin-bottom: 15px;"><span class="pg-green">✅ Strong Compliance (Business Tier)</span></h4>
...
<h4 style="background-color: #ffebee; padding: 10px; border-radius: 4px; display: inline-block; margin-bottom: 15px;"><span class="pg-red">❌ Cloud-Only Deployment</span></h4>
...
<h4 style="background-color: #e8f5e9; padding: 10px; border-radius: 4px; display: inline-block; margin-bottom: 15px;"><span class="pg-green">✅ IP Indemnification</span></h4>
...
<div style="overflow: hidden;">
<div style="float: right; margin-left: 15px;">
<img src="https://cursor.sh/brand/logo.svg" alt="Cursor logo" width="128">
</div>
<div>
...
<h4 style="background-color: #fff3e0; padding: 10px; border-radius: 4px; display: inline-block; margin-bottom: 15px;"><span class="pg-orange">⚠️ Data Sent to Third-Party Models</span></h4>
...
<h4 style="background-color: #e8f5e9; padding: 10px; border-radius: 4px; display: inline-block; margin-bottom: 15px;"><span class="pg-green">✅ Privacy Mode</span></h4>
...
<h4 style="background-color: #ffebee; padding: 10px; border-radius: 4px; display: inline-block; margin-bottom: 15px;"><span class="pg-red">❌ No Self-Hosting or Compliance Audits</span></h4>
...
<div style="background-color: #e8f5e9; border-left: 4px solid #4caf50; padding: 16px; margin: 20px 0; border-radius: 4px;">
<div style="overflow: hidden;">
<div style="float: right; margin-left: 15px; background-color: #000; padding: 10px;">
<img src="https://www.anthropic.com/images/anthropic_logo_white.svg" alt="Anthropic logo" width="128">
</div>
<div>
